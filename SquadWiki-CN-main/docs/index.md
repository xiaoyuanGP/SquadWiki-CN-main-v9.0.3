...
战术小队中文维基自2025年4月23日起活跃更新，感谢各位的支持。
...
《战术小队》(Squad)是由Offworld Industries开发的一款**大型多人在线战术射击游戏**，通过KickStarter众筹并在Steam平台发行。

游戏支持最多100名玩家同场竞技，强调团队协作与战术配合，玩家需要共同规划前哨建设、人员部署和战术执行。

当前发布版本：[v8.2.1](./update/v8.2.1/release-notes/)
...
- 2024年12月5日：修复了MGS车辆成本问题，从30张票更改为正确的10张票
- 修复了CAF豹式主战坦克发动机部件穿透车辆后部装甲网的问题
- Kohat Toi RAAS v1 - 修复了南部主基地中某些直升机在中心起降点生成时爆炸的问题
- 修复了所有使用M27 IAR的非自动步枪手角色弹匣数量错误的问题，从12个更改为正确的7个
- 修复了USMC M39 EMR狙击步枪在高倍率下准星过于像素化的问题。
- 202412月3日：战术小队V8.2版本引入了四款新武器、好友列表功能以及大量平衡性调整，将于国内时间12月3日凌晨更新。
- 2024年2月12日：更新三贤岛地图指南
- 2023年12月23日：地图指南更新至v7.0.1版本
- 2023年12月22日：更新BMC、ACV、PARS、M60T、UH-1H系列载具数据
- 2023年12月21日：更新5.0.1至7.0.1版本英文更新日志
- 2023年12月17日：更新中国海军陆战队和土耳其陆军阵营资料
